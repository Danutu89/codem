      ...
      return [
        {
          ...
          payload: {
            ...
            ...(event.payload.detail ? { detail: event.payload.requestType === "plan_approval" ? event.payload.detail : truncateDetail(event.payload.detail, 800) } : {}),
            ...(event.payload.args ? { args: event.payload.args } : {}),
          },
